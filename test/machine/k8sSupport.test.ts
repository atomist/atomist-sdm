...
import { GitProject, InMemoryProject } from "@atomist/sdm/lib/client";
import {
...
describe("k8sSupport", () => {
	describe("kubernetesApplicationData", () => {
		...
		it("should detect atomist-sdm", async () => {
			...
			const p: GitProject = InMemoryProject.of({
				path: "package.json",
				content: '{"dependencies":{"@atomist/sdm":"^2.0.0"}}',
			}) as any;
			const g: KubernetesDeploy = {} as any;
			const v: SdmGoalEvent = {
				environment: "2-prod",
		...
		it("should provide an ingress", async () => {
			...
			const p: GitProject = InMemoryProject.of({
				path: "package.json",
				content: '{"dependencies":{"@atomist/automation-client":"*"}}',
			}) as any;
			const g: KubernetesDeploy = {} as any;
			const v: SdmGoalEvent = {
				environment: "1-staging",
