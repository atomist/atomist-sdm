...
import { ProjectIdentifier } from "@atomist/sdm/lib/core";
import { IsNode, NodeProjectIdentifier } from "@atomist/sdm/lib/pack/node";
        ...
        return configuration.sdm.projectLoader.doWithProject(
            ...
            async (project: GitProject) => {
                ...
                try {
                    ...
                    const formulaeProject = await GitCommandGitProject.cloned(credentials, formulaeRepo, {
                        depth: 1000,
                    });
                    ...
                    const prResp: HttpResponse<{ html_url: string; number: number }> = await httpClient.exchange(
                        brewPrUrl,
                        brewPrOptions,
                    );
