...
export const stagingDeploy = new KubernetesDeploy({
	environment: "testing",
	approval: true,
});
export const orgVisualizerStagingDeploy = new KubernetesDeploy({
	environment: "testing",
});
export const productionDeploy = new KubernetesDeploy({
	environment: "production",
});
export const orgVisualizerProductionDeploy = new KubernetesDeploy({
	environment: "production",
});
export const productionDeployWithApproval = new KubernetesDeploy({
	environment: "production",
	approval: true,
});
...
export const DockerReleaseAndHomebrewGoals = goals(
	"Docker and Homebrew with Release",
)
	.plan(DockerReleaseGoals)
	.plan(releaseHomebrew)
	.after(release);

export const SimpleDockerReleaseGoals = goals(
	"Simple Docker Build with Release",
)
	.plan(version)
	.plan(dockerBuild)
	.after(version)
...
export const noOpGoalExecutor = (): Promise<ExecuteGoalResult> =>
	Promise.resolve({ code: 0, message: "Nothing to do" });
