 ...
 * @param sdmName Name this k8s-sdm should registration as.
...
export function addK8sSecret(app: KubernetesApplication, goal: KubernetesDeploy, sdmName: string): KubernetesApplication {
    ...
    const config: Configuration = {
        ...
        environment: sdmName.split("_")[1],
        applicationEvents: goal.sdm.configuration.applicationEvents,
        cluster: goal.sdm.configuration.cluster,
        logging: goal.sdm.configuration.logging,
        statsd: goal.sdm.configuration.statsd,
